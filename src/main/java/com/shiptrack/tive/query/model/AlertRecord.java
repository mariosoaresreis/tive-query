...
/**
 * Read-only JPA entity backed by the tive_alerts table.
 *
 * The table is owned and written by tive-webhook-receiver.
 * This entity is annotated {@code @Immutable} — no writes ever happen from this service.
 */
@Getter
@Entity
@Immutable
